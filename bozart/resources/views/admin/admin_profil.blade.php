            ...
            <div class="card-body">
                ...
                @if ( $admin->user->photo)
                        <div class="row justify-content-center" style="align-content: center">
                            ...
                            <img src="{{ asset('storage/image/photo_profil/'.$admin->user->photo) }}">
                        ...
                        <div class="row justify-content-center" style="align-content: center">
                            <button onclick="modifierPhoto({{ $admin->user->id }});"
                                class="btn">
                                <span>
                ...
                @else
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <button onclick="modifierPhoto({{ $admin->user->id }});" class="btn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $admin->user->nom }} </strong>
                    </div>

                    <div class="col-lg-3">
                        <button onclick="modifierNom({{ $admin->user->id }}, '{{ $admin->user->nom }}');"
                            class="btn">
                            <span>
                                <i class="fas fa-pen"></i>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $admin->user->prenom }} </strong>
                    </div>

                    <div class="col-lg-3">
                        <button onclick="modifierPrenom({{ $admin->user->id }}, '{{ $admin->user->prenom }}');"
                            class="btn">
                            <span>
                                <i class="fas fa-pen"></i>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $admin->user->genre }} </strong>
                    </div>

                    <div class="col-lg-3">
                        <button onclick="modifierGenre({{ $admin->user->id }}, '{{ $admin->user->genre }}');"
                            class="btn">
                            <span>
                                <i class="fas fa-pen"></i>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $admin->user->telephone }} </strong>
                    </div>

                    <div class="col-lg-3">
                        <button onclick="modifierTelephone({{ $admin->user->id }}, '{{ $admin->user->telephone }}');"
                            class="btn">
                            <span>
                                <i class="fas fa-pen"></i>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <button onclick="modifierEmail({{ $admin->user->id }}, '{{ $admin->user->email }}');"
                            class="btn">
                            <span>
                                <i class="fas fa-pen"></i>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        @if ( $admin->user->date_de_naissanse )
                            <strong> {{ $admin->user->date_de_naissanse }} </strong>
                    ...
                    <div class="col-lg-3">
                        @if ( ! $admin->user->date_de_naissanse )
                            ...
                            <button onclick="modifierDate_de_naissance({{ $admin->user->id }}, '{{ $admin->user->date_de_naissanse }}');" class="btn">
                                <span>
                                    <i class="fas fa-pen"></i>
                                </span>
                                <span class="text">Définir</span>
